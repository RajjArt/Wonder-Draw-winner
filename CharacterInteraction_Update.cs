using UnityEngine;
// using UnityEngine.UI; // Replace old UI references with TMPro
using TMPro; // Required for TextMeshProUGUI
using UnityEngine.UI; // Keep this for Image and Canvas components
using System;
...
namespace CharacterInteractionSystem
{
    ...
    public class CharacterInteraction : MonoBehaviour
    {
        ...
        // CHANGED: Use TextMeshProUGUI instead of UnityEngine.UI.Text
        ...
        private void SetupWorldCanvas()
        {
            ...
            _worldCanvas.AddComponent<GraphicRaycaster>();
            ...
            // CHANGED: Use AddComponent<TextMeshProUGUI>()
            _feedbackText = textObj.AddComponent<TextMeshProUGUI>();
            // Removed reliance on GetBuiltinResource<Font> which can be finicky
        ...
        /// </summary>
        // Rest of the class methods (ShowVisualFeedback, ShowSubtleFeedback, etc.) were cut off.
        // Assuming the rest of the file follows standard C# practices and just needs to be appended here.
        private void ShowVisualFeedback()
        {
            if (_characterMaterial != null)
            {
                ...
                StopAllCoroutines();
                // Ensure the required System.Collections namespace is added at the top of the file
        ...
        /// </summary>
        // NOTE: Ensure 'using System.Collections;' is added to the top of your script file.
